      ...
      <div className="HotelOverviewMain">
        <div className="OverviewBox">
          <h2 className="OverviewHotelName">
            {/**JS till Array */}Sunset Hotel - Kurreklubben
            <img
              style={{ height: "2rem", margin: "-1rem auto auto 2rem" }}
          ...
          <div className="starsForHotel">
            ...
            <p>
              {/**JS till Array */}Lorem ipsum dolor sit amet, consectetur
        ...
        <div className="HotelInfoSummary">
          ...
          <div className="priceFrom">
            ...
            <h1 style={{ color: "black" }}>1295 kr</h1>
