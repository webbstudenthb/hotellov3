              ...
              <div className="HotelInfoSummary">
                ...
                <div className="priceFrom">
                  ...
                  <div className="buttons">
                    <NavLink to={writeData.Hotel_Checkout_Route} style={{ textDecoration: "none" }}>
                    <div>
...
function HogvallenFjallHotellcheckout() {
...
export { HogvallenFjallHotell, HogvallenFjallHotellcheckout };
